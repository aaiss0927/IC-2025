...
python ./L-CAD/colorization_main_cus.py             \
    --train                                     \
    --img_root  ./train/gt_image                \
    --caption_root ./train                      \
    --init_ckpt ./prt_ckpt/multi_weight.ckpt    \
    --gpus 1                                    \
    --batch 1                                   \
    --lr 1e-6
...
python ./L-CAD/colorization_main.py             \
    ...
    --lr 5e-6
-------------------------------------------------
nohup python ./L-CAD/colorization_main_cus.py       \
    --train                                     \
    --img_root  ./train/gt_image                \
    --caption_root ./train                      \
    --init_ckpt ./prt_ckpt/multi_weight.ckpt    \
...
from colorization_dataset_cus import MyDataset
...
def get_parser():
    ...
    p.add_argument(
        "--epochs", type=int, default=6, help="number of training epochs"  # ★ 추가
    )
